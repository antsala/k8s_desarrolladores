...
# Vamos a instalar Helm si no lo estuviera:
...
# La salida mostrará algo parecido a esto:
# (Nota: Observar el pod con el nombre 'prometheus-operator')
#
...
# (Nota: Observar todos los objetos con 'operator' en el nombre)
# NAME                                                      READY   STATUS    RESTARTS   AGE
...
# Helm crea un montón de objetos de configuración:
# (Nota: observar los objetos)

kubectl get configmap


# Helm crea un montón de Secretos:
# (Nota: observar los secretos)
