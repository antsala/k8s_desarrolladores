...
#               IMPORTANTE. Poner en la línea 13 el usuario que hemos creado 'luke@antsalgrahotmail.onmicrosoft.com'
...
# IMPORTANTE: Para que Luke pueda interactuar con la subscripción hay que asignarle un rol en la misma.
# Lo hacemos con la interfaz web de azure: 'Home / Subscriptions / MSDN Platforms /Access Control (IAM)'
