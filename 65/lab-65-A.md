...
# Las líneas más interesantes son:
#
# Líneas 17-21:     Se levanta un contenedor de ubuntu que realiza un simple bucle infinito para que no
#                   se detenga el contenedor. El contenedor se llamará 'test-container'
...
# Ahora necesitamos entrar en el contenedor del pod. Ajustar el nombre del pod según convenga:
# (Nota: Esto debe devolver un prompt dentro del contenedor)
...
# Ahora probamos si desde dentro del contenedor se puede alcanzar el servicio externo:
...
# Salimos del contenedor con 'exit' y borramos los recursos:
