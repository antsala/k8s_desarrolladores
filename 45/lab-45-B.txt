...
#
#   3) Desplegar el cluster EKS en AWS (Ver lab-01.txt)
...
# Si 'EXTERNAL-IP' se quedan en 'Pending' esperar un poco porque AWS aún no ha asignado IP.
# (NOTA: no continuar hasta tener la 'EXTERNAL-IP')

# Podemos conectar con un navegador a:'http://aa554514004624ce9b896ff5781c9995-2125204655.eu-west-1.elb.amazonaws.com'
# para ver la app funcionando en EKS.
...
# Comprobar que hay 6 instancias de pod del frontend y que están repartidas entre los tres nodos workers.
