...
# En el directorio de trabajo, existe una carpeta llamada 'website', que contiene el archivo
# 'index.html' con la aplicación web. Este archivo por comodidad en la explicación es muy
# elemental. Lo editamos con el siguiente comando.

code ./website/index.html

# Una vez observada la aplicación, cerramos sin modificar el archivo.

# Aquí viene lo importante. Vamos a ejecutar un contenedor que monte un volumen. En la sintaxis
# para montar el volumen, debemos especificar dos rutas:
#
#   1) Ruta del host: Es la carpeta donde está la aplicación, el archivo 'index.html'. Si el
#      directorio actual es '~/k8s_desarrolladores/03/volumen', la ruta de la aplicación es
#      '$PWD/website'.
#
#   2) Ruta en el contenedor: Es la carpeta donde se realizará el montaje en el contenedor.
#      En este caso, necesitamos que sea la carpeta en la que nginx espera encontrar los
#      archivos de la aplicación, es decir, '/var/www/html/website' 
#
#   El tercer argumento del volumen es 'ro' o 'rw', e indica si el contenedor puede modificar
#   los archivos del host.
#
# El comando que inicia el contenedor con el volumen es el siguiente.
# (Nota: observar el al final 'docker run' se ejecuta la aplicación 'nginx', sin argumentos)
...
# Añaadimos, debajo de la línea 6, el siguiente código (sin incluir las comillas simples):
