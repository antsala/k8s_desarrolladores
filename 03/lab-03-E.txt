...
# Ahora procedemos a estudiar un archivo de manifiesto de ejemplo. Este se encuentra en la carpeta:
# '~/k8s_desarrolladores/03/helloContainerSvc', así que entramos en ella.
...
# Y para ver los contenedores que ha levantado, con este otro comando:

sudo docker stack ps helloContainerStack


# Cuya salida será similar a la siguiente, en la que podemos ver los 5 contenedores corriendo.
#
